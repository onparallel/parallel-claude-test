      ...
      body={
        <Text>
          <FormattedMessage
            ...
            defaultMessage="We have detected <b>{count}</b> parallels or templates using this token. If you delete it, the configuration will be reset and all pending signature processes will be cancelled. Are you sure you want to delete it?"
