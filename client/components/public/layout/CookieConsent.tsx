...
export function CookieConsent({}: CookieConsentProps) {
  return (
    ...
    >
      ...
      <Box flex="1" marginLeft={6} marginRight={4}>
        <Heading fontSize="md">
          <FormattedMessage
            id="component.cookie-consent.header"
            defaultMessage="Cookies on Parallel"
          ></FormattedMessage>
        </Heading>
        <Text fontSize="sm">
          <FormattedMessage
            id="component.cookie-consent.description"
            defaultMessage="We use analytics cookies that allow us to understand how users navigate around our website. These cookies will only be used if you grant consent and you will always be allowed to reject them at any moment. <a>Read more</a>"
            values={{
              a: (...chunks: any[]) => (
                <Link
                  href="/legal/[doc]"
      ...
      >
        ...
        >
          <FormattedMessage
            id="component.cookie-consent.reject-button"
