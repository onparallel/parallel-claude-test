...
export function PetitionListGenericSimpleFilter<T extends string>(
  options: { value: T; text: string }[]
) {
  return function PetitionListGenericSimpleFilter({
    value,
    onChange,
  }: TableColumnFilterProps<T[] | null>) {
      ...
      () => ({
        ...
        onClick: (e: MouseEvent) => {
          ...
          if (index === 0) {
            ...
            const option = options[index - 1]?.value;
            if (option) {
