...
export default function Accounting() {
  ...
  const hero = {
    image: `${process.env.NEXT_PUBLIC_ASSETS_URL}/static/images/hero/accounting_hero_${locale}`,
  ...
  const benefitsImage = `${process.env.NEXT_PUBLIC_ASSETS_URL}/static/images/solutions/accounting_benefits_${locale}.png`;
  const benefits = [
    {
