...
export default function Consultancy() {
  ...
  const hero = {
    image: `${process.env.NEXT_PUBLIC_ASSETS_URL}/static/images/hero/consultancy_hero_${locale}`,
  ...
  const benefitsImage = `${process.env.NEXT_PUBLIC_ASSETS_URL}/static/images/solutions/consultancy_benefits_${locale}.png`;
  const benefits = [
    {
  ...
  return (
    ...
    >
      ...
      <PublicContainer paddingY={8} maxWidth="container.xl" wrapper={{ paddingY: 16 }}>
        <PublicShowcase
          imageUrl={`${process.env.NEXT_PUBLIC_ASSETS_URL}/static/images/solutions/consultancy_usecase_${locale}.svg`}
          imageSize="330px"
        >
