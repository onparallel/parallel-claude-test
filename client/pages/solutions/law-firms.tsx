...
export default function LawFirms() {
  ...
  const hero = {
    image: `${process.env.NEXT_PUBLIC_ASSETS_URL}/static/images/hero/lawfirms_hero_${locale}`,
  ...
  const benefitsImage = `${process.env.NEXT_PUBLIC_ASSETS_URL}/static/images/solutions/lawfirms_benefits_${locale}.svg`;
  const benefits = [
    {
  ...
  return (
    ...
    >
      ...
      <PublicContainer paddingY={8} maxWidth="container.xl" wrapper={{ paddingY: 16 }}>
        <PublicShowcase
          imageUrl={`${process.env.NEXT_PUBLIC_ASSETS_URL}/static/images/solutions/lawfirms_usecase_${locale}.svg`}
          imageSize="330px"
