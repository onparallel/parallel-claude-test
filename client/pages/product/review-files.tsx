...
export default function Review() {
  ...
  return (
    ...
    >
      ...
      <PublicContainer paddingY={8} maxWidth="container.lg" marginBottom={16}>
        <PublicVideoShowcase
          videoSources={[
            {
              type: "video/mp4",
              src: `${process.env.NEXT_PUBLIC_ASSETS_URL}/static/videos/review-files-${locale}.mp4`,
            },
          ]}
          videoSize="300px"
        >
      ...
      >
        <PublicShowcase
          imageUrl={`${process.env.NEXT_PUBLIC_ASSETS_URL}/static/images/product/review-files/parallel-export-${locale}.svg`}
          imageSize="350px"
          isReversed
        >
          <Heading as="h3" size="lg" color="gray.800" marginBottom={4}>
      ...
      <PublicContainer paddingY={8} maxWidth="container.lg" wrapper={{ paddingY: 16 }}>
        <PublicShowcase
          imageUrl={`${process.env.NEXT_PUBLIC_ASSETS_URL}/static/images/product/review-files/parallel-activity-${locale}.svg`}
          imageSize="350px"
        >
          <Heading as="h3" size="lg" color="gray.800" marginBottom={4}>
            <FormattedMessage
