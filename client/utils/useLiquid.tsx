...
function useCreateLiquid() {
  return useConstant(() => {
    ...
    engine.registerFilter("number", function (value: number, digits?: number) {
    ...
    engine.registerFilter("currency", function (value: number, currency: string) {
      if (typeof value !== "number" && typeof value !== "bigint") {
        return undefined;
      }
      const intl = (this.context.globals as any)["intl"] as IntlShape;
    ...
    engine.registerFilter("percent", function (value: number, digits?: number) {
      if (typeof value !== "number" && typeof value !== "bigint") {
        return undefined;
      }
      const intl = (this.context.globals as any)["intl"] as IntlShape;
