...
export function buildConfig() {
  return deepFreeze({
    ...
    queueWorkers: {
      ...
      "delay-queue": {
        queueUrl: process.env.WORKERS_DELAY_QUEUE_ENDPOINT!,
    ...
    cronWorkers: {
      ...
      anonymizer: {
        ...
        deleteScheduledPetitionsAfterDays: parseInt(
          process.env.WORKERS_ANONYMIZER_DELETE_SCHEDULED_PETITIONS_AFTER_DAYS!,
        ),
      },
      "old-notifications": {
