/**
 * this is an partial declaration of signaturit-sdk module
 * full API here: https://docs.signaturit.com/api/latest
 * */
...
declare module "signaturit-sdk" {
  ...
  export = class SignaturitClient {
    ...
    getSignature: (signatureId: string) => Promise<SignatureResponse>;
  };
