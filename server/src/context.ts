...
export class ApiContext {
  ...
  constructor(
    ...
    // Repositories
    @inject(ContactRepository) public readonly contacts: ContactRepository,
    @inject(EmailLogRepository) public readonly emailLogs: EmailLogRepository,
    @inject(FeatureFlagRepository) public readonly featureFlags: FeatureFlagRepository,
    @inject(FileRepository) public readonly files: FileRepository,
    @inject(IntegrationRepository) public readonly integrations: IntegrationRepository,
    @inject(UserRepository) public readonly users: UserRepository,
    @inject(OrganizationRepository) public readonly organizations: OrganizationRepository,
    @inject(PetitionRepository) public readonly petitions: PetitionRepository,
    @inject(UserAuthenticationRepository)
    public readonly userAuthentication: UserAuthenticationRepository,
    @inject(UserGroupRepository) public readonly userGroups: UserGroupRepository,
    @inject(TagRepository) public readonly tags: TagRepository,
    @inject(SystemRepository) public readonly system: SystemRepository,
    @inject(SubscriptionRepository) public readonly subscriptions: SubscriptionRepository,
    @inject(TaskRepository) public readonly tasks: TaskRepository,
    @inject(LicenseCodeRepository) public readonly licenseCodes: LicenseCodeRepository,
    @inject(ViewRepository) public readonly views: ViewRepository,
    @inject(ProfileRepository) public readonly profiles: ProfileRepository,
    @inject(DashboardRepository) public readonly dashboards: DashboardRepository,
    @inject(PetitionApprovalRequestRepository)
    public readonly approvalRequests: PetitionApprovalRequestRepository,
    @inject(PetitionCommentRepository) public readonly petitionComments: PetitionCommentRepository,
  ) {}
}
