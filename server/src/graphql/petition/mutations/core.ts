...
import {
  ...
  fieldIsNotFixed,
  fieldIsNotReferencedOnLogicConditions,
...
export const deletePetitionField = mutationField("deletePetitionField", {
  ...
  authorize: authenticateAnd(
    ...
    petitionsAreNotPublicTemplates("petitionId"),
    petitionIsNotAnonymized("petitionId"),
    fieldIsNotReferencedOnLogicConditions("petitionId", "fieldId"),
  ...
  authorize: authenticateAnd(
    ...
    ifNotEmptyArray(
      ...
      and(
        ...
        fieldIsNotReferencedOnLogicConditions("petitionId", "childrenFieldIds"),
        fieldIsNotBeingUsedInAutoSearchConfig("petitionId", "childrenFieldIds"),
